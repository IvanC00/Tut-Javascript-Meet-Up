...
class Status{
    constructor(){
        ...
        this.statisticData; //variable to hold the response from the server
        this.loadData();
    ...
    loadExperience(event = null){
        ...
        new Chart(this.$experienceCanvas, {type: 'pie', data});
    ...
    loadProfession(event = null){
        ...
        new Chart(this.$professionCanvas, {type: 'pie', data})
    }
    ...
    loadAge(event = null){
        ...
        new Chart(this.$ageCanvas, {type: 'pie', data});
    }
